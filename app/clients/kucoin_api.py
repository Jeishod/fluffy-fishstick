...
from app.utils.enums import CandleType, OrdersCount, OrderType, Symbols, TradeSide, TradeStatus, TradeType, RequestMethod
from app.utils.helpers import gen_hashed_string, get_sign_string
...
class KucoinClient:
    ...
    async def send_request(
        ...
        LOGGER.debug(f"request_id: {request_id} | {method} | url: {url}")
